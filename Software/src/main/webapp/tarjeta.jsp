...
<main class="main">
    ...
    <div class="grid-container-2" align="center">
        <div>
            <font face="times new roman" color="#8b4513">Los juegos del hambre &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            $249.00 MXN </font>
        ...
        <div>
            <font face="times new roman" color="#8b4513">Luna nueva &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            $399.00 MXN </font>
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <input type="number">
        ...
        <div>
            <font color="#8b4513">Harry Potter &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            $249.00 MXN </font>
    ...
    <div>
        ...
        <br>&nbsp&nbsp&nbsp&nbsp&nbsp<input type="button" value="Comprar"/><br/><br>
    </div>
</main>
