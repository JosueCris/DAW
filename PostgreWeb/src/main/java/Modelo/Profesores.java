...
public class Profesores implements Serializable {
    ...
    public Profesores(int idProfesor, String nombre, String aPaterno, String aMaterno, String tipoContrato, int eeEspecializa, String direccion, String telefono, String celular, String tipoEstudios, String email, String fechaNac, String lugarEstudios) {
        this.idProfesor = idProfesor;
        this.nombre = nombre;
